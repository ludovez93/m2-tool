...
## Prossimo step
- PUSH dell'allineamento parser su `main` (escludendo `_test-align/` e i `*.bak`) — in attesa OK Ludovico.
- Dopo il push: prova reale su iPhone con una lista-notte vera (incollare → Elabora → aprire scheda difetto/NO DAC → verificare i campi compilati).
